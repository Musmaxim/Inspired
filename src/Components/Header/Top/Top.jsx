    ...
    <div className={s.top}>
      <Container className={s.container}>
        ...
        <ul className={s.navList}>
            <li className={s.navItem}><button className={s.link}><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M16.4431 16.4438L20.9994 21.0002" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <li className={s.navItem}><a className={s.link}><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
